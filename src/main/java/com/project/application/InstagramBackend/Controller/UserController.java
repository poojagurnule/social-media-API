...
import com.project.application.InstagramBackend.Service.RepostService;
...
public class UserController {
    ...
    public String repost(@PathVariable Integer postId, @RequestParam String email, @RequestParam String token) {
        if (authenticationService.authenticate(email, token)) {
            return repostService.repost(postId, email);
        } else {
            return "Not an Authenticated user activity!!!";
        }
    }
